...
def AlarmIntoMysql(ZipFilePath,jrsjid):
    try:
        ...
        try:
            ...
            cursor = conn.cursor()
            cursor.execute(sql)
            print('alarmfile存入成功11111111111111111111111111111111111111111111111111111111')
        except Exception as e:
            print("AlarmIntoMysql(2) ----- ",e)
        finally:
            cursor.close()
            conn.close()
            ...
            for item in filenames:
                if ".json" in item:
                    ...
                    try:
                        ...
                        cursor = conn.cursor()
                        cursor.execute(sql)
                        print('ocffile表存入成功1111111111111111111111111111111111111111111111111111111111111')
                    except Exception as e:
            ...
            for item in filenames:
                if ".TXT" in item:
                    ...
                    try:
                        ...
                        cursor = conn.cursor()
                        cursor.execute(sql)
                        print('cgqxzhfile存入成功11111111111111111111111111111111111111111111111111111111')
                    except Exception as e:
                        print("CgqxzhIntoMysql(2) ----- ",e)
                    finally:
                        cursor.close()
                        conn.close()
            TarFile.close()
            ...
            for item in filenames:
                if ".TXT" in item:
                    ...
                    try:
                        ...
                        cursor = conn.cursor()
                        cursor.execute(sql)
                        print('hjqxzhfile存入成功11111111111111111111111111111111111111111111111111111111')
                    except Exception as e:
                        print("HjqxzhIntoMysql(2) ----- ",e)
                    finally:
                        cursor.close()
                        conn.close()
            TarFile.close()
            ...
            for item in filenames:
                if ".TXT" in item:
                    ...
                    try:
                        ...
                        cursor = conn.cursor()
                        cursor.execute(sql)
                        print('dxjbzhfile存入成功11111111111111111111111111111111111111111111111111111111')
                    except Exception as e:
...
def GetJrsjByTypeNoFileStore(qxsjtype):
    ...
    try:
        ...
        try:
            ...
            print("GetJrsjByTypeNoFileStore(2) ----- ",e)
        finally:
            return jrsj
            cursor.close()
            conn.close()
