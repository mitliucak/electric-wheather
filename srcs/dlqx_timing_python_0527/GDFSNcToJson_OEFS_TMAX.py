...
def ReadFromNc(filePath):
    ...
    #最高温度
    Maximum_temperature_height_above_ground_24_Hour_Maximum = (nc_obj.variables['Maximum_temperature_height_above_ground_24_Hour_Maximum'][:])
    ...
    ncdatadict['Maximum_temperature_height_above_ground_24_Hour_Maximum'] = Maximum_temperature_height_above_ground_24_Hour_Maximum
    return ncdatadict
...
def NcToJson(ncdatadict, jrsjid1, jrsjid2, jrsjid3, AttrName):
    try:
        ...
        try:
            ...
            Maximum_temperature_height_above_ground_24_Hour_Maximum = ncdatadict['Maximum_temperature_height_above_ground_24_Hour_Maximum']
            ...
            for i in range(TimeDimension):
                for j in range(LatDimension):
                    for k in range(LonDimension):
                        ...
                        lat = Lat[j]
                        lon = Lon[k]
                        maximum_temperature = Maximum_temperature_height_above_ground_24_Hour_Maximum[i, 0, j, k]
                        attr = Attr[i, 0, j, k]
                        ...
                        NcOneObjectDict['temperature_max'] = round(float(maximum_temperature), 6)
                        NcOneObjectDict[AttrName] = 0
                        #NcOneObjectDict[AttrName] = attr
                        jsondictList.append(NcOneObjectDict)

                        # #=============================连接数据库==================================
                        sql1 = "INSERT INTO tb_gdfs_temperature_max(gdfs_temperature_max_time,gdfs_temperature_max_lat,gdfs_temperature_max_lon,gdfs_temperature_max_value,gdfs_temperature_max_jrsjid) \
                                VALUES ('%s','%s','%s','%s','%s')" % (time,lat,lon,maximum_temperature,jrsjid1)
                        sql2 = "INSERT INTO tb_gdfs_temperature_max(gdfs_temperature_max_time,gdfs_temperature_max_lat,gdfs_temperature_max_lon,gdfs_temperature_max_value,gdfs_temperature_max_jrsjid) \
                                VALUES ('%s','%s','%s','%s','%s')" % (time,lat,lon,maximum_temperature,jrsjid2)
                        sql3 = "INSERT INTO tb_gdfs_temperature_max(gdfs_temperature_max_time,gdfs_temperature_max_lat,gdfs_temperature_max_lon,gdfs_temperature_max_value,gdfs_temperature_max_jrsjid) \
                                VALUES ('%s','%s','%s','%s','%s')" % (time,lat,lon,maximum_temperature,jrsjid3)

                        try:
                            cursor1.execute(sql1)
                            print('tb_gdfs_temperature_max存入成功')
                            print('111111111111111111111111111111111111111111111111111111111111111111111111111')
                            # conn1.commit()
                        except Exception as e:
                            print("GDFSNcToJson_OEFS_TMAX(1) ----- ",e)
                        ...
                        try:
                            ...
                            print("GDFSNcToJson_OEFS_TMAX(2) ----- ",e)
                        ...
                        try:
                            ...
                            print("GDFSNcToJson_OEFS_TMAX(3) ----- ",e)
            ...
            print("GDFSNcToJson_OEFS_TMAX 文件解析异常 ----- ")

    except Exception as e:
        print("GDFSNcToJson_OEFS_TMAX 数据库连接异常 ----- ")
    finally:
        cursor1.close()
        conn1.close()
        cursor2.close()
