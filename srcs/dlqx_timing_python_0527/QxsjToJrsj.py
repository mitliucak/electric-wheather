    ...
    try:
        for item in qxsjs:
            ...
            sql = "INSERT INTO tb_jrsj(jrsj_filetime, jrsj_stationcategory, jrsj_filename, jrsj_fileformat, jrsj_filesize, jrsj_jrinterface, jrsj_jrtime, jrsj_location,jrsj_qxtype) \
                       VALUES ('%s', '%s', '%s', '%s', '%s', '%s','%s','%s','%s')" % (jrsjfiletime, jrsjstationcategory, jrsjfilename, jrsjfileformat, jrsjfilesize, jrsjjrinterface,jrsjjrtime,jrsjlocation,jrsjqxtype)
            # print(sql)
            try:
    ...
    try:
        for item in qxsjs:
            ...
            sql = "INSERT INTO tb_jrsj(jrsj_filetime, jrsj_alarmtype, jrsj_filename, jrsj_fileformat, jrsj_filesize, jrsj_jrinterface, jrsj_jrtime, jrsj_location,jrsj_qxtype) \
                       VALUES ('%s', '%s', '%s', '%s', '%s', '%s','%s','%s','%s')" % (jrsjfiletime, jrsjalarmtype, jrsjfilename, jrsjfileformat, jrsjfilesize, jrsjjrinterface,jrsjjrtime,jrsjlocation,jrsjqxtype)
            try:
                conn1 = jaydebeapi.connect(driver,jdbc_url1,uandp,jar_file)
                cursor1 = conn1.cursor()
                cursor1.execute(sql)
    ...
    try:
        for item in qxsjs:
            ...
            sql = "INSERT INTO tb_jrsj(jrsj_filetime, jrsj_filename, jrsj_fileformat, jrsj_filesize, jrsj_jrinterface, jrsj_jrtime, jrsj_location,jrsj_qxtype) \
                       VALUES ('%s', '%s', '%s', '%s', '%s','%s','%s','%s')" % (jrsjfiletime, jrsjfilename, jrsjfileformat, jrsjfilesize, jrsjjrinterface,jrsjjrtime,jrsjlocation,jrsjqxtype)
            try:
                conn1 = jaydebeapi.connect(driver,jdbc_url1,uandp,jar_file)
                cursor1 = conn1.cursor()
                cursor1.execute(sql)
    ...
    try:
        for item in qxsjs:
            ...
            sql = "INSERT INTO tb_jrsj(jrsj_filetime, jrsj_ybfactor, jrsj_filename, jrsj_fileformat, jrsj_filesize, jrsj_jrinterface, jrsj_jrtime, jrsj_location,jrsj_qxtype) \
                       VALUES ('%s', '%s', '%s','%s', '%s', '%s','%s','%s','%s')" % (jrsjfiletime, jrsjybfactor, jrsjfilename, jrsjfileformat, jrsjfilesize, jrsjjrinterface,jrsjjrtime,jrsjlocation,jrsjqxtype)
            try:
                conn1 = jaydebeapi.connect(driver,jdbc_url1,uandp,jar_file)
                cursor1 = conn1.cursor()
                cursor1.execute(sql)
