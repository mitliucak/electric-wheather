...
def ReadFromNc(filePath):
    ...
    nc_obj.variables['Maximum_temperature_height_above_ground_24_Hour_Maximum'][:])
    ...
    ncdatadict[
        'Maximum_temperature_height_above_ground_24_Hour_Maximum'] = Maximum_temperature_height_above_ground_24_Hour_Maximum
    return ncdatadict
...
def NcToJson(ncdatadict, jrsjid1, jrsjid2, jrsjid3, AttrName):
    try:
        ...
        try:
            ...
            Maximum_temperature_height_above_ground_24_Hour_Maximum = ncdatadict[
                'Maximum_temperature_height_above_ground_24_Hour_Maximum']
