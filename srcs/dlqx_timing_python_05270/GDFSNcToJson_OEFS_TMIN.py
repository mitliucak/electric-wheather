...
def ReadFromNc(filePath):
    ...
    nc_obj.variables['Minimum_temperature_height_above_ground_24_Hour_Minimum'][:])
    ...
    ncdatadict[
        'Minimum_temperature_height_above_ground_24_Hour_Minimum'] = Minimum_temperature_height_above_ground_24_Hour_Minimum
    return ncdatadict
...
def NcToJson(ncdatadict, jrsjid1, jrsjid2, jrsjid3, AttrName):
    try:
        ...
        try:
            ...
            Minimum_temperature_height_above_ground_24_Hour_Minimum = ncdatadict[
                'Minimum_temperature_height_above_ground_24_Hour_Minimum']
