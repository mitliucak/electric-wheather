...
def ReadFromNc(filePath):
    ...
    # 降水相态
    Precipitation_type_surface_3_Hour_Accumulation = (
    nc_obj.variables['Precipitation_type_surface_3_Hour_Accumulation'][:])
...
def NcToJson(ncdatadict, jrsjid1, jrsjid2, jrsjid3, AttrName):
    try:
        ...
        try:
            ...
            Precipitation_type_surface_3_Hour_Accumulation = ncdatadict[
                'Precipitation_type_surface_3_Hour_Accumulation']
