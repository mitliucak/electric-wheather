...
def ReadFromNc(filePath):
    ...
    nc_obj.variables['Total_precipitation_surface_3_Hour_Accumulation'][:])
...
def NcToJson(ncdatadict, jrsjid1, jrsjid2, jrsjid3, AttrName):
    try:
        ...
        try:
            ...
            Total_precipitation_surface_3_Hour_Accumulation = ncdatadict[
                'Total_precipitation_surface_3_Hour_Accumulation']
                ...
                for j in range(LatDimension):
                    for k in range(LonDimension):
                        ...
                        try:
                            ...
                            print("GDFSNcToJson_QPF_R03(1) ----- ")

                        try:
                            cursor2.execute(sql2)
                            # conn2.commit()
                        except Exception as e:
                            print("GDFSNcToJson_QPF_R03(2) ----- ")

                        try:
                            cursor3.execute(sql3)
                            # conn3.commit()
                        except Exception as e:
                            print("GDFSNcToJson_QPF_R03(3) ----- ")
